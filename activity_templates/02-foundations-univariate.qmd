...
- Work on these exercises in your groups. (Collaboration is a key learning goal in this course, which we'll discuss in the coming classes.)       
    ...
    - We might not discuss all of these exercises as a class. Your group should ask me questions as I walk around the room when I will tell you to do in group.
    - **Choose one person from your group to answer questions on behalf of the group. The role of group representative will rotate each class meeting.**



**Finish the activity**

- Some activities are important to learn and in that case I will tell you that we will finish the activities next class.

- Otherwise, if we can't finish some activities which can be finished outside of the class and/or you didn’t finish the activity during class, be sure to complete the activity outside of class, review the solutions in the online manual (at the end of in-class activities!), and ask any questions in office hours (me and preceptors).
...
## Exercise 1: Importing and getting to know the data **[Group]**
...
## Exercise 2: Preparing to summarize and visualize the data **[Explore]**
...
## Exercise 3: Exploring themes in the letters [Group & Explore]
...
** Open class-Notes and start live note-taking! **
