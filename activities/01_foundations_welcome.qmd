...
Download the .qmd file for this activity [here](../activity_templates/01_foundations_welcome.qmd). For this and all future activities, you will download the .qmd file, open it in Rstudio, and use it to type your answers/code to the exercises on the in-class activities. A rendered ("printed") version of the activity will always be available on this course page.
