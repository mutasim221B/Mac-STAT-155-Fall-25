...
# install.packages(c("dplyr","kableExtra"))  # run once if needed
library(dplyr)
library(kableExtra)

# helper for bullet-style line breaks that work in HTML & PDF
lb <- function(...) kableExtra::linebreak(c(...), align = "l")
...
df <- tibble::tribble(
  ...
  "Simple linear regression",
  "Model the relationship of a quantitative response (y) with one predictor/explanatory variable (x).",
  lb("Univariate visual & numerical summaries"),
  "",
  "", "", lb("Simple linear regression",
  ...
  "",
  "", "", lb("Transformations"), "",
  "", "", lb("Categorical predictors"), "",

  # ---------- Multiple linear regression ----------
  "Multiple linear regression",
  "Model the relationship of a quantitative response (y) with multiple predictors (x₁, x₂, …, xₚ).",
  lb("Multiple linear regression",
     "Multivariate visualization",
     "Model coefficients",
     "Predictions & residuals"),
  "4–7",
  "", "", lb("Confounding & interaction"), "",
  "", "", lb("Model building"), "",

  # ---------- Logistic regression ----------
  "Logistic regression",
  "Model the relationship of a binary categorical response (y) with one or more predictors (x₁, x₂, …, xₚ).",
  lb("Measuring uncertainty",
     "log(odds) vs odds vs probability"),
  "8–9",
  "", "", lb("Logistic regression",
             "Visualization",
             "Model coefficients",
             "Predictions & residuals"),
  "",
  ...
  # ---------- Inference ----------
  "Inference",
  "Use regression models built on sample data to make inferences about the broader population from which the data were drawn.",
  lb("Normal distribution"), "10–14",
  "", "", lb("Sampling distributions & the CLT"), "",
  "", "", lb("Confidence intervals"), "",
  "", "", lb("Hypothesis tests"), ""
)
...
kbl(
  ...
  align = c("l","l","l","c"),
  booktabs = TRUE,
  escape = FALSE,                              # allow math like R$^2$
  caption = "STAT 155 — Units, goals, topics, and approximate weeks"
) |>
