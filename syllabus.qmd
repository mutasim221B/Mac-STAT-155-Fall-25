...
::: {.column width="40%" style="padding-right:25px;"}
...
::: {.column width="60%" style="padding-right:25px;"}
...
| Modifier            | Scenario                                                                 |
|:--------------------|:-------------------------------------------------------------------------|
| none <br>(e.g. A → A) | Meets expectations in all 3 areas (Engagement, Collaboration, Preparation) |
| ⅓ lower grade <br>(e.g. A → A-) | Demonstrates strong progress toward expectations (e.g., 4 absences or 70% checkpoint total) |
| 1 lower grade <br>(e.g. A → B)  | Demonstrates moderate progress (e.g., 5–6 absences or 50% checkpoint total) |
