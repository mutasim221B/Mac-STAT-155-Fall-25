...
::: {.column width="40%" style="padding-right:24px;"}
### Course Percentage
...
::: {.column width="60%" style="padding-left:24px;"}
### Grade Modifiers
...
| ⅓ lower grade <br>(e.g. A → A-)  | Demonstrates strong progress (e.g., 4 absences or 70% checkpoint total)  |
...
**NOTE:** The table presents general scenarios. Please reach out if you want to discuss progress in Engagement, Collaboration, and/or Preparation.
:::
