...
gt_tbl <- df |>
  gt() |>
  tab_header(title = md("**STAT 155 — Units, goals, topics, and approximate weeks**")) |>
  cols_align(align = "left") |>
  # turn OFF zebra striping (note the dots in the option name)
  tab_options(row.striping.include = FALSE) |>
  # render <br> and inline math like R$^2$ in GOAL/TOPIC
