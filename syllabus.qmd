...
::: {.column width="30%" style="padding-right:25px;"}
...
::: {.column width="70%" style="padding-right:25px;"}
...
| $\tfrac{1}{3}$ lower grade (eg: A → A-) | Demonstrates strong progress toward expectations (e.g., 4 absences or 70% checkpoint total) |
| 1 lower grade (eg: A → B)               | Demonstrates moderate progress (e.g., 5–6 absences or 50% checkpoint total) |
