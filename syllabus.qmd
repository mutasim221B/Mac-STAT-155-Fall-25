...
![](images/Mutasim_Pic.jpg){width=180px fig-align="right"}
...
Greetings! You can call me *Bill* or *Professor Bill*, or *Professor Billah*. Back when I was an undergrad student, I didn’t have the best experience in Intro Stat—those courses often emphasized formulas over real understanding. That experience has shaped my teaching—over my seven years as a GTI (Graduate Teaching Instructor) at UNCo and MTU, I’ve focused on showing how statistical theories connect and how they can be applied in the real world. I’m excited to teach STAT 155 now in Macalester College and to create a more meaningful experience—one that encourages some students to continue studying Statistics, and helps all students feel confident applying it beyond the classroom. My methodological research lies at the intersection of statistical genetics, biostatistics, and genomics. My current research interests include developing novel statistical methods and computationally efficient bioinformatics tools, leveraging modern machine- and deep-learning approaches analyze high-dimensional next-generation sequencing and multi-omics data to identify genes and regulatory mechanisms underlying complex diseases. Outside of my academic work, I enjoy spending time outdoors with family and friends or cooking variety of foods. If you can’t find me anywhere, I might be busy playing soccer or exploring new worlds on my PS5 Pro!
:::

**Drop-in (office) hours**:

-   **Location**: My office (OLRI 234)
-   **Times**: M/W: 01:30-02:30pm.
-   **1:1 appointments**: I'm also happy to meet one-on-one if my normal drop-in hours don't work for you. Shoot me an email and we can arrange it either in-person or over zoom [zoom](https://macalester.zoom.us/j/99762878654?pwd=gt7VvSNT0ubKsV2icMV3z8J0GyHKMy.1), password: 123456.

## Overview

**Welcome to STAT 155!** Whether in life or research, we’re often interested in relationships between 2+ variables. For example, how is one’s commute time to class related to their distance from campus and mode of transportation? Or, 
how is voter participation related to a person’s age and political affiliation? **Statistical modeling** is the art and science of turning data into information about such relationships of interest.
