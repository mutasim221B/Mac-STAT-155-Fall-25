...
-   **By Appointment:** I'm also happy to meet one-on-one if my normal drop-in hours don't work for you. Shoot me an email and we can arrange it either in-person or over [zoom](https://macalester.zoom.us/j/99762878654?pwd=gt7VvSNT0ubKsV2icMV3z8J0GyHKMy.1), password: 123456.
...
The [online course manual](https://mutasim221b.github.io/Mac-STAT-155-Fall-25/) includes all in-class activities (with solutions) and a daily [Schedule](schedule.qmd). All links and materials needed will be provided on the schedule tab of this website.
...
- CPs are due **30 minutes before class** on the assigned date. **There are no extensions for CPs**, as they are important *preparation* for the relevant class session.  
:::

## (4) Practice (Practice Problem Sets)
...
- **Quiz 1:** Monday, 09/22 in class (tentative) 
- **Quiz 2:** Monday, 10/27 in class (tentative)
- **Quiz 3:** *Finals week*  
...
| ⅓ lower grade <br>(e.g. A → A-)  | Demonstrates strong progress (e.g., 4 absences OR less than 13 (out of 17) CPs (≈80%))  |
| 1 lower grade <br>(e.g. A → B)   | Demonstrates moderate progress (e.g., 5–6 absences OR less than 8 (out of 17) CPs (≈50%)) |
...
- Don’t miss any Checkpoint quizzes—they are designed to give you a core understanding of the subject matter!
...
Here are some comments from previous students in my **Engineering Statistics** class at Michigan Tech that may help you succeed in STAT 155 as well!

- Pay attention to the class lectures, and take notes. Makes the entire class 10x easier.
- Go to the office hours. He is a really kind professor, and will help so much during the course. The course isn't hard if you have been through higher levels of math, but getting to know professor Billah is just a joy and can make the course so much more fun, not to mention he will definitely make your day.
