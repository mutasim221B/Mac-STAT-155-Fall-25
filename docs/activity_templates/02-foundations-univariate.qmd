...
-   Introduced **Tidy Data** and described what an **observation**, **case** (or **unit of analysis**) represents in a dataset.
-   Described what a **variable** represents in a dataset.
-   Identified whether a variable is **categorical** or **quantitative** and 
