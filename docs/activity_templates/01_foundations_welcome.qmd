...
You can view the .qmd file for this activity [here](../activity_templates/01_foundations_welcome.qmd); I will also share the .qmd activity file before the class via moodle announcement. 
